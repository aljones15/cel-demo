...
#curl -X PUT http://127.0.0.1:8000/schedules -H 'Content-Type: application/json' -d '{"event_id":"urn:schedule:example","state_date_time":"2025-04-11T22:36:24.681Z","duration":"180000","name":"Mow The Lawn","repeat":"Weekly-Monday"}'
